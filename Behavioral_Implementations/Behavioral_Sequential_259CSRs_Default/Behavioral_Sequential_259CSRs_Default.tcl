...
#
# Behavioral_Sequential_259CSRs_Default.tcl: Tcl script for re-creating project 'PerfOptCSRs'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../src/sources/ip/clk_wiz_1/clk_wiz_1.xci"]"\
...
# "[file normalize "$origin_dir/../src/sim/toplevel_tb_behav.wcfg"]"\
 "[file normalize "$origin_dir/../src/utils/toplevel_routed.dcp"]"\
  ]
  foreach ifile $files {
...
#set _xil_proj_name_ "Vivado-Behavioral_Sequential_259CSRs_Default"
set _xil_proj_name_ "Vivado-Behav_259Seq_Def"
...
set script_file "Behavioral_Sequential_259CSRs_Default.tcl"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a100tcsg324-1 -flow {Vivado Synthesis 2022} -strategy "Flow_AreaOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a100tcsg324-1 -flow {Vivado Implementation 2022} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run impl_1
} else {
...
# Create 'impl_1_route_report_qor_suggestions_write_flow' report (if not found)
if { [ string equal [get_report_configs -of_objects [get_runs impl_1] impl_1_route_report_qor_suggestions_write_flow] "" ] } {
  create_report_config -report_name impl_1_route_report_qor_suggestions_write_flow -report_type report_qor_suggestions:1.0 -steps route_design -runs impl_1
}
set obj [get_report_configs -of_objects [get_runs impl_1] impl_1_route_report_qor_suggestions_write_flow]
if { $obj != "" } {
...
set obj [get_runs impl_1]
set_property -name "needs_refresh" -value "1" -objects $obj
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/utils/toplevel_routed.dcp" -objects $obj
set_property -name "auto_rqs" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/impl_1" -objects $obj
