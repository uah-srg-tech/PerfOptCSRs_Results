...
--constant HPM_NUM_COUNTERS   : natural   := 32;
--constant HPM_NUM_COUNTERS   : natural   := 24;
...
constant HPM_NUM_COUNTERS   : natural   := 3;
...
constant CSR_HPMCOUNTER5    : std_logic_vector(11 downto 0) := X"c05";
constant CSR_HPMCOUNTER6    : std_logic_vector(11 downto 0) := X"c06";
constant CSR_HPMCOUNTER7    : std_logic_vector(11 downto 0) := X"c07";
constant CSR_HPMCOUNTER8    : std_logic_vector(11 downto 0) := X"c08";
constant CSR_HPMCOUNTER9    : std_logic_vector(11 downto 0) := X"c09";
constant CSR_HPMCOUNTER10   : std_logic_vector(11 downto 0) := X"c0A";
constant CSR_HPMCOUNTER11   : std_logic_vector(11 downto 0) := X"c0B";
constant CSR_HPMCOUNTER12   : std_logic_vector(11 downto 0) := X"c0C";
constant CSR_HPMCOUNTER13   : std_logic_vector(11 downto 0) := X"c0D";
constant CSR_HPMCOUNTER14   : std_logic_vector(11 downto 0) := X"c0E";
constant CSR_HPMCOUNTER15   : std_logic_vector(11 downto 0) := X"c0F";
constant CSR_HPMCOUNTER16   : std_logic_vector(11 downto 0) := X"c10";
constant CSR_HPMCOUNTER17   : std_logic_vector(11 downto 0) := X"c11";
constant CSR_HPMCOUNTER18   : std_logic_vector(11 downto 0) := X"c12";
constant CSR_HPMCOUNTER19   : std_logic_vector(11 downto 0) := X"c13";
constant CSR_HPMCOUNTER20   : std_logic_vector(11 downto 0) := X"c14";
constant CSR_HPMCOUNTER21   : std_logic_vector(11 downto 0) := X"c15";
constant CSR_HPMCOUNTER22   : std_logic_vector(11 downto 0) := X"c16";
constant CSR_HPMCOUNTER23   : std_logic_vector(11 downto 0) := X"c17";
constant CSR_HPMCOUNTER24   : std_logic_vector(11 downto 0) := X"c18";
constant CSR_HPMCOUNTER25   : std_logic_vector(11 downto 0) := X"c19";
constant CSR_HPMCOUNTER26   : std_logic_vector(11 downto 0) := X"c1A";
constant CSR_HPMCOUNTER27   : std_logic_vector(11 downto 0) := X"c1B";
constant CSR_HPMCOUNTER28   : std_logic_vector(11 downto 0) := X"c1C";
constant CSR_HPMCOUNTER29   : std_logic_vector(11 downto 0) := X"c1D";
constant CSR_HPMCOUNTER30   : std_logic_vector(11 downto 0) := X"c1E";
...
constant CSR_HPMCOUNTER5H   : std_logic_vector(11 downto 0) := X"c85";
constant CSR_HPMCOUNTER6H   : std_logic_vector(11 downto 0) := X"c86";
constant CSR_HPMCOUNTER7H   : std_logic_vector(11 downto 0) := X"c87";
constant CSR_HPMCOUNTER8H   : std_logic_vector(11 downto 0) := X"c88";
constant CSR_HPMCOUNTER9H   : std_logic_vector(11 downto 0) := X"c89";
constant CSR_HPMCOUNTER10H  : std_logic_vector(11 downto 0) := X"c8A";
constant CSR_HPMCOUNTER11H  : std_logic_vector(11 downto 0) := X"c8B";
constant CSR_HPMCOUNTER12H  : std_logic_vector(11 downto 0) := X"c8C";
constant CSR_HPMCOUNTER13H  : std_logic_vector(11 downto 0) := X"c8D";
constant CSR_HPMCOUNTER14H  : std_logic_vector(11 downto 0) := X"c8E";
constant CSR_HPMCOUNTER15H  : std_logic_vector(11 downto 0) := X"c8F";
constant CSR_HPMCOUNTER16H  : std_logic_vector(11 downto 0) := X"c90";
constant CSR_HPMCOUNTER17H  : std_logic_vector(11 downto 0) := X"c91";
constant CSR_HPMCOUNTER18H  : std_logic_vector(11 downto 0) := X"c92";
constant CSR_HPMCOUNTER19H  : std_logic_vector(11 downto 0) := X"c93";
constant CSR_HPMCOUNTER20H  : std_logic_vector(11 downto 0) := X"c94";
constant CSR_HPMCOUNTER21H  : std_logic_vector(11 downto 0) := X"c95";
constant CSR_HPMCOUNTER22H  : std_logic_vector(11 downto 0) := X"c96";
constant CSR_HPMCOUNTER23H  : std_logic_vector(11 downto 0) := X"c97";
constant CSR_HPMCOUNTER24H  : std_logic_vector(11 downto 0) := X"c98";
constant CSR_HPMCOUNTER25H  : std_logic_vector(11 downto 0) := X"c99";
constant CSR_HPMCOUNTER26H  : std_logic_vector(11 downto 0) := X"c9A";
constant CSR_HPMCOUNTER27H  : std_logic_vector(11 downto 0) := X"c9B";
constant CSR_HPMCOUNTER28H  : std_logic_vector(11 downto 0) := X"c9C";
constant CSR_HPMCOUNTER29H  : std_logic_vector(11 downto 0) := X"c9D";
constant CSR_HPMCOUNTER30H  : std_logic_vector(11 downto 0) := X"c9E";
...
constant CSR_MTDELEG     : std_logic_vector(11 downto 0) := X"302";
...
constant CSR_MHPMCOUNTER5   : std_logic_vector(11 downto 0) := X"B05";
constant CSR_MHPMCOUNTER6   : std_logic_vector(11 downto 0) := X"B06";
constant CSR_MHPMCOUNTER7   : std_logic_vector(11 downto 0) := X"B07";
constant CSR_MHPMCOUNTER8   : std_logic_vector(11 downto 0) := X"B08";
constant CSR_MHPMCOUNTER9   : std_logic_vector(11 downto 0) := X"B09";
constant CSR_MHPMCOUNTER10  : std_logic_vector(11 downto 0) := X"B0A";
constant CSR_MHPMCOUNTER11  : std_logic_vector(11 downto 0) := X"B0B";
constant CSR_MHPMCOUNTER12  : std_logic_vector(11 downto 0) := X"B0C";
constant CSR_MHPMCOUNTER13  : std_logic_vector(11 downto 0) := X"B0D";
constant CSR_MHPMCOUNTER14  : std_logic_vector(11 downto 0) := X"B0E";
constant CSR_MHPMCOUNTER15  : std_logic_vector(11 downto 0) := X"B0F";
constant CSR_MHPMCOUNTER16  : std_logic_vector(11 downto 0) := X"B10";
constant CSR_MHPMCOUNTER17  : std_logic_vector(11 downto 0) := X"B11";
constant CSR_MHPMCOUNTER18  : std_logic_vector(11 downto 0) := X"B12";
constant CSR_MHPMCOUNTER19  : std_logic_vector(11 downto 0) := X"B13";
constant CSR_MHPMCOUNTER20  : std_logic_vector(11 downto 0) := X"B14";
constant CSR_MHPMCOUNTER21  : std_logic_vector(11 downto 0) := X"B15";
constant CSR_MHPMCOUNTER22  : std_logic_vector(11 downto 0) := X"B16";
constant CSR_MHPMCOUNTER23  : std_logic_vector(11 downto 0) := X"B17";
constant CSR_MHPMCOUNTER24  : std_logic_vector(11 downto 0) := X"B18";
constant CSR_MHPMCOUNTER25  : std_logic_vector(11 downto 0) := X"B19";
constant CSR_MHPMCOUNTER26  : std_logic_vector(11 downto 0) := X"B1A";
constant CSR_MHPMCOUNTER27  : std_logic_vector(11 downto 0) := X"B1B";
constant CSR_MHPMCOUNTER28  : std_logic_vector(11 downto 0) := X"B1C";
constant CSR_MHPMCOUNTER29  : std_logic_vector(11 downto 0) := X"B1D";
constant CSR_MHPMCOUNTER30  : std_logic_vector(11 downto 0) := X"B1E";
...
constant CSR_MHPMCOUNTER5H  : std_logic_vector(11 downto 0) := X"B85";
constant CSR_MHPMCOUNTER6H  : std_logic_vector(11 downto 0) := X"B86";
constant CSR_MHPMCOUNTER7H  : std_logic_vector(11 downto 0) := X"B87";
constant CSR_MHPMCOUNTER8H  : std_logic_vector(11 downto 0) := X"B88";
constant CSR_MHPMCOUNTER9H  : std_logic_vector(11 downto 0) := X"B89";
constant CSR_MHPMCOUNTER10H : std_logic_vector(11 downto 0) := X"B8A";
constant CSR_MHPMCOUNTER11H : std_logic_vector(11 downto 0) := X"B8B";
constant CSR_MHPMCOUNTER12H : std_logic_vector(11 downto 0) := X"B8C";
constant CSR_MHPMCOUNTER13H : std_logic_vector(11 downto 0) := X"B8D";
constant CSR_MHPMCOUNTER14H : std_logic_vector(11 downto 0) := X"B8E";
constant CSR_MHPMCOUNTER15H : std_logic_vector(11 downto 0) := X"B8F";
constant CSR_MHPMCOUNTER16H : std_logic_vector(11 downto 0) := X"B90";
constant CSR_MHPMCOUNTER17H : std_logic_vector(11 downto 0) := X"B91";
constant CSR_MHPMCOUNTER18H : std_logic_vector(11 downto 0) := X"B92";
constant CSR_MHPMCOUNTER19H : std_logic_vector(11 downto 0) := X"B93";
constant CSR_MHPMCOUNTER20H : std_logic_vector(11 downto 0) := X"B94";
constant CSR_MHPMCOUNTER21H : std_logic_vector(11 downto 0) := X"B95";
constant CSR_MHPMCOUNTER22H : std_logic_vector(11 downto 0) := X"B96";
constant CSR_MHPMCOUNTER23H : std_logic_vector(11 downto 0) := X"B97";
constant CSR_MHPMCOUNTER24H : std_logic_vector(11 downto 0) := X"B98";
constant CSR_MHPMCOUNTER25H : std_logic_vector(11 downto 0) := X"B99";
constant CSR_MHPMCOUNTER26H : std_logic_vector(11 downto 0) := X"B9A";
constant CSR_MHPMCOUNTER27H : std_logic_vector(11 downto 0) := X"B9B";
constant CSR_MHPMCOUNTER28H : std_logic_vector(11 downto 0) := X"B9C";
constant CSR_MHPMCOUNTER29H : std_logic_vector(11 downto 0) := X"B9D";
constant CSR_MHPMCOUNTER30H : std_logic_vector(11 downto 0) := X"B9E";
...
constant CSR_MHPMEVENT5     : std_logic_vector(11 downto 0) := X"325";
constant CSR_MHPMEVENT6     : std_logic_vector(11 downto 0) := X"326";
constant CSR_MHPMEVENT7     : std_logic_vector(11 downto 0) := X"327";
constant CSR_MHPMEVENT8     : std_logic_vector(11 downto 0) := X"328";
constant CSR_MHPMEVENT9     : std_logic_vector(11 downto 0) := X"329";
constant CSR_MHPMEVENT10    : std_logic_vector(11 downto 0) := X"32A";
constant CSR_MHPMEVENT11    : std_logic_vector(11 downto 0) := X"32B";
constant CSR_MHPMEVENT12    : std_logic_vector(11 downto 0) := X"32C";
constant CSR_MHPMEVENT13    : std_logic_vector(11 downto 0) := X"32D";
constant CSR_MHPMEVENT14    : std_logic_vector(11 downto 0) := X"32E";
constant CSR_MHPMEVENT15    : std_logic_vector(11 downto 0) := X"32F";
constant CSR_MHPMEVENT16    : std_logic_vector(11 downto 0) := X"330";
constant CSR_MHPMEVENT17    : std_logic_vector(11 downto 0) := X"331";
constant CSR_MHPMEVENT18    : std_logic_vector(11 downto 0) := X"332";
constant CSR_MHPMEVENT19    : std_logic_vector(11 downto 0) := X"333";
constant CSR_MHPMEVENT20    : std_logic_vector(11 downto 0) := X"334";
constant CSR_MHPMEVENT21    : std_logic_vector(11 downto 0) := X"335";
constant CSR_MHPMEVENT22    : std_logic_vector(11 downto 0) := X"336";
constant CSR_MHPMEVENT23    : std_logic_vector(11 downto 0) := X"337";
constant CSR_MHPMEVENT24    : std_logic_vector(11 downto 0) := X"338";
constant CSR_MHPMEVENT25    : std_logic_vector(11 downto 0) := X"339";
constant CSR_MHPMEVENT26    : std_logic_vector(11 downto 0) := X"33A";
constant CSR_MHPMEVENT27    : std_logic_vector(11 downto 0) := X"33B";
constant CSR_MHPMEVENT28    : std_logic_vector(11 downto 0) := X"33C";
constant CSR_MHPMEVENT29    : std_logic_vector(11 downto 0) := X"33D";
constant CSR_MHPMEVENT30    : std_logic_vector(11 downto 0) := X"33E";
...
constant CSR_MHPMEVENT0H  : std_logic_vector(11 downto 0) := X"720";
--constant CSR_MHPMEVENT1H  : integer := 16#721#;
constant CSR_MHPMEVENT2H  : std_logic_vector(11 downto 0) := X"722";
constant CSR_MHPMEVENT3H  : std_logic_vector(11 downto 0) := X"723";
constant CSR_MHPMEVENT4H  : std_logic_vector(11 downto 0) := X"724";
constant CSR_MHPMEVENT5H  : std_logic_vector(11 downto 0) := X"725";
constant CSR_MHPMEVENT6H  : std_logic_vector(11 downto 0) := X"726";
constant CSR_MHPMEVENT7H  : std_logic_vector(11 downto 0) := X"727";
constant CSR_MHPMEVENT8H  : std_logic_vector(11 downto 0) := X"728";
constant CSR_MHPMEVENT9H  : std_logic_vector(11 downto 0) := X"729";
constant CSR_MHPMEVENT10H : std_logic_vector(11 downto 0) := X"72A";
constant CSR_MHPMEVENT11H : std_logic_vector(11 downto 0) := X"72B";
constant CSR_MHPMEVENT12H : std_logic_vector(11 downto 0) := X"72C";
constant CSR_MHPMEVENT13H : std_logic_vector(11 downto 0) := X"72D";
constant CSR_MHPMEVENT14H : std_logic_vector(11 downto 0) := X"72E";
constant CSR_MHPMEVENT15H : std_logic_vector(11 downto 0) := X"72F";
constant CSR_MHPMEVENT16H : std_logic_vector(11 downto 0) := X"730";
constant CSR_MHPMEVENT17H : std_logic_vector(11 downto 0) := X"731";
constant CSR_MHPMEVENT18H : std_logic_vector(11 downto 0) := X"732";
constant CSR_MHPMEVENT19H : std_logic_vector(11 downto 0) := X"733";
constant CSR_MHPMEVENT20H : std_logic_vector(11 downto 0) := X"734";
constant CSR_MHPMEVENT21H : std_logic_vector(11 downto 0) := X"735";
constant CSR_MHPMEVENT22H : std_logic_vector(11 downto 0) := X"736";
constant CSR_MHPMEVENT23H : std_logic_vector(11 downto 0) := X"737";
constant CSR_MHPMEVENT24H : std_logic_vector(11 downto 0) := X"738";
constant CSR_MHPMEVENT25H : std_logic_vector(11 downto 0) := X"739";
constant CSR_MHPMEVENT26H : std_logic_vector(11 downto 0) := X"73A";
constant CSR_MHPMEVENT27H : std_logic_vector(11 downto 0) := X"73B";
constant CSR_MHPMEVENT28H : std_logic_vector(11 downto 0) := X"73C";
constant CSR_MHPMEVENT29H : std_logic_vector(11 downto 0) := X"73D";
constant CSR_MHPMEVENT30H : std_logic_vector(11 downto 0) := X"73E";
