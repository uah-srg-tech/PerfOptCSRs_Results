...
#
# PerfOptCSRs_DSPmux_Floorplanning_Overconstraining_Directive.tcl: Tcl script for re-creating project 'PerfOptCSRs'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../src/sources/ip/clk_wiz_0/clk_wiz_0.xci"]"\
...
# "[file normalize "$origin_dir/../src/utils/toplevel.dcp"]"\
 "[file normalize "$origin_dir/../src/utils/toplevel_postroute_physopt.dcp"]"\
 "[file normalize "$origin_dir/../src/utils/pre_place.tcl"]"\
 "[file normalize "$origin_dir/../src/utils/pre_route.tcl"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "Vivado-DSPmux_FplnOvt_Dir"
...
set script_file "PerfOptCSRs_DSPmux_Floorplanning_Overconstraining_Directive.tcl"
...
#set file "toplevel.dcp"
#set file_obj [get_files -of_objects [get_filesets utils_1] [list "*$file"]]
#set_property -name "library" -value "work" -objects $file_obj
#set_property -name "netlist_only" -value "0" -objects $file_obj

set file "pre_place.tcl"
set file_obj [get_files -of_objects [get_filesets utils_1] [list "*$file"]]
set_property -name "library" -value "work" -objects $file_obj

set file "pre_route.tcl"
set file_obj [get_files -of_objects [get_filesets utils_1] [list "*$file"]]
set_property -name "library" -value "work" -objects $file_obj
...
#set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/utils/toplevel.dcp" -objects $obj
...
#set_property -name "steps.place_design.tcl.pre" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/utils/pre_place.tcl" -objects $obj
...
#set_property -name "steps.route_design.tcl.pre" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/utils/pre_route.tcl" -objects $obj
